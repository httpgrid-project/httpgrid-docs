...
This page has everything you need to start sending webhooks with HTTPgrid.
...
Get your authentication token (`AuthToken`) from the [HTTPgrid dashboard](https://example.com).
